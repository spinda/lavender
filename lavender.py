...
class FileMode:
    ...
    string_normalization: str = "single"
...
@click.option(
    ...
    is_flag=True,
    help=(
        "Treat empty lines between classes and defs differently from other code, inserting double empty lines where appropriate."
    ),
)
@click.option(
    "--check",
    ...
    def contains_inner_type_comments(self) -> bool:
        ...
        try:
            ...
            if last_leaf.type == token.COMMA:
                # When trailing commas are inserted by Lavender for consistency, comments
...
class LineGenerator(Visitor[Line]):
    ...
    def visit_default(self, node: LN) -> Iterator[Line]:
        ...
        if isinstance(node, Leaf):
            ...
            if self.string_normalization != "none" and node.type == token.STRING:
...
def normalize_string_quotes(leaf: Leaf, string_normalization: str = "single") -> None:
    ...
    desired_quote = "'" if string_normalization == "single" else '"'
    undesired_quote = '"' if string_normalization == "single" else '"'
